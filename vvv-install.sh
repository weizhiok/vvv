...
files=(host.sh landing.sh center_install.sh register_sync.sh vvv_manager.sh sub_center.py sync_agent.py backup_manager.py rclone_manager.sh client_adapters.py client_package_renderer.py name_guard_runtime.py adapter_manager.py client_upgrade_engine.py client_local_renderer.py hy2_port_hop.py hy2_port_hop.sh center_transport.sh center_manager.sh restore_manager.py diagnostic_report.py node_probe.py)
...
python3 -m py_compile "$TMP/app/sub_center.py" "$TMP/app/sync_agent.py" "$TMP/app/backup_manager.py" "$TMP/app/client_adapters.py" "$TMP/app/client_package_renderer.py" "$TMP/app/name_guard_runtime.py" "$TMP/app/adapter_manager.py" "$TMP/app/client_upgrade_engine.py" "$TMP/app/client_local_renderer.py" "$TMP/app/hy2_port_hop.py" "$TMP/app/restore_manager.py" "$TMP/app/diagnostic_report.py" "$TMP/app/node_probe.py" || fail "Python 模块语法检查失败。"
