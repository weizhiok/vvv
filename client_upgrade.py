...
This file is intentionally data/rendering only. It must not read or write server
files, start processes, change services, or modify proxy state. Installed VPSes
fetch it through the fixed local client upgrade engine.
"""
